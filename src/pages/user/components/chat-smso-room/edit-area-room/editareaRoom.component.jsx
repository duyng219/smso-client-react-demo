        ...
        <Hero>
            <div className="detail-area">
                <div className="detail-area-header">
                    ...
                    <div className="detail-title">Group 03</div>
                    <div className="detail-subtitle">Created by Group 03, 01 Jul 2022</div>
                ...
                <a href="/" className="follow-me" target="_blank">
